...
**Generated on:** 2025-10-07 14:00:31  
...
| `easybroker_accounts` | BASE TABLE | 10 | Application data storage |
| `easybroker_properties_staging` | BASE TABLE | 37 | Application data storage |
...
| `easybroker_accounts` | `easybroker_accounts_user_id_account_name_key` | `CREATE UNIQUE INDEX easybroker_accounts_user_id_account_name_key ON public.easybroker_accounts USING btree (user_id, account_name)` |
